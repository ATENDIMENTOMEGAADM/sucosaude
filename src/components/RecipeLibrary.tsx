...
import { Search, Eye, Leaf, Clock, ChefHat, Sparkles, ArrowRight, SlidersHorizontal, X } from 'lucide-react';
...
export const RecipeLibrary: React.FC<RecipeLibraryProps> = ({ onNavigate }) => {
  ...
  const themeCards = [
    {
      ...
      keywords: ['olhos', 'visão', 'vision', 'eyes'],
      prepTime: '10 min',
      difficulty: 'Fácil',
  ...
  const filters = [
    ...
    { id: 'olhos', label: 'Saúde Ocular', icon: <Eye className="w-3.5 h-3.5" /> },
  ];
